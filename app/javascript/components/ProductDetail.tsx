...
export default function ProductDetail(props:Props) {
  ...
  var sizes:NodeListOf<Element>, colors:NodeListOf<Element>, shoes:NodeListOf<any>
  var gradients:NodeListOf<Element>, shoeBackground:any, shoeHeight
  var prevColor = "blue";
    ...
    <div className="Home">
      <div className="container">
        <div className="card">
          ...
          <Info products={product.products} colors={product.colors} sizes={product.sizes} url_prefix={props.url_prefix}/>
        </div>
      </div>
    </div>
  );
