...
export default function OrderForm(props:Props) {
  ...
  const getTitle = () => {
    if (isInput) {
      return <h1>注文情報の入力</h1>
    } else if (isConfirm) {
      return <h1>注文情報の確認</h1>
    } else {
      return <h1>注文完了</h1>
    }
  }
          ...
          <Grid item xs={12} sm={6}>
            <FormControl margin="normal" fullWidth>
              <TextField id="last_name" type="text" label="氏名"
               ...
               value={lastName} onChange={changeLastName} InputProps={{readOnly: !isInput,}} />
            </FormControl>
          </Grid>
          <Grid item xs={12} sm={6}>
            <FormControl margin="normal" fullWidth>
              ...
              　value={firstName} onChange={changeFirstName} InputProps={{readOnly: !isInput,}} />
            </FormControl>
          </Grid>
          <Grid item xs={12} sm={6}>
            <FormControl margin="normal" fullWidth>
              ...
              　value={mail} onChange={changeMail} InputProps={{readOnly: !isInput,}} />
            </FormControl>
          </Grid>
          <Grid item xs={12} sm={6}>
            <FormControl margin="normal" fullWidth>
              ...
              　value={tel} onChange={changeTel} InputProps={{readOnly: !isInput,}} />
            </FormControl>
          </Grid>
          <Grid item xs={12} sm={6}>
            <FormControl margin="normal" fullWidth>
              ...
              　value={zip} onChange={changeZip} InputProps={{readOnly: !isInput,}} />
            </FormControl>
          </Grid>
          <Grid item xs={12}>
            <FormControl margin="normal" fullWidth>
              ...
              　value={address} onChange={changeAddress} InputProps={{readOnly: !isInput,}} />
            </FormControl>
          </Grid>
        </Grid>
      </div>
    ...
    if (isInput) {
      return (
        <div className={classes.wrapper}>
          <Button variant="contained" color="primary" size="medium" className={buttonClassname} onClick={toConfirm}
      ...
      return (
        <div>
          <div className={classes.wrapper}>
            <Button variant="contained" color="primary" size="medium" className={buttonClassname} onClick={toInput}
             disabled={loading}>
              入力画面へ戻る
            </Button>
            {loading && <CircularProgress size={24} className={classes.buttonProgress} />}
          ...
          <div className={classes.wrapper}>
            <Button variant="contained" color="primary" size="medium" className={buttonClassname} onClick={toComplete}
             disabled={loading || 0 < errors!.cart.length || 0 >= cartItems.length}>
              注文確定
            </Button>
            {loading && <CircularProgress size={24} className={classes.buttonProgress} />}
